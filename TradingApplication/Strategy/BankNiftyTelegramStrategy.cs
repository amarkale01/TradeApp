        ...
        public async Task ReadMessageFromChannel()
        {
            ...
            if (_client != null && _client.IsConnected && _client.IsUserAuthorized())
            {
                ...
                var chat = dialogs.Chats
                    .OfType<TLChannel>()
                    .FirstOrDefault(c => c.Title == "Intraday Banknifty Calls");//.FirstOrDefault(c => c.Title == "Trade Easy Free Calls");.FirstOrDefault(c => c.Title == "Trading Hub");.FirstOrDefault(c => c.Title == "TradingView");
